...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.d("FIREBASE", "remote message : "+remoteMessage.getNotification());
        ...
        if(remoteMessage.getCollapseKey() != null){
            Log.d("FIREBASE", "Message Collapse key : " + remoteMessage.getCollapseKey());
        }
    ...
    public void createNotification(String title){
        ...
        notificationBuilder.setContentTitle("NK, Featured place of the week!");
